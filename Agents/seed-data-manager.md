...
roles:
  - "qa"
summary: "Manages Playwright test fixtures, data factories, seeding scripts, and cleanup — generating unique per-run data, auth-state caching, and API-based seed/teardown."
aiTools:
  - "Claude Code"
  - "Claude Chat"
tags:
