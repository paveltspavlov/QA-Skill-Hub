...
roles:
  - "qa"
summary: "Takes Playwright execution results, extracts structured bug entries for each failure, saves JSON and markdown bug reports, and optionally opens GitHub issues for Critical/High bugs."
aiTools:
  - "Claude Code"
  - "Claude Chat"
tags:
...
- `qa_ecosystem/skills/bug_reporter_workflow.md`
...
- Save your full results to `.vscode/current_task/<NN>-bug-reporter.md` (`<NN>` = step number from qa-manager, `00` standalone), with these sections so any reasoning error is traceable: **Inputs used**, **Assumptions**, **Work performed**, **Output**, **Files created/modified**, **Open issues**.
