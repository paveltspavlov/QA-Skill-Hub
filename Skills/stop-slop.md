...
folder: skills
section: writing
summary: "Eliminate predictable AI writing patterns from prose — cut filler, break formulaic structures, kill adverbs, prefer active voice."
aiTools:
  - "Claude Code"
  - "Claude Chat"
  - "ChatGPT"
...
1. **Cut filler phrases.** Remove throat-clearing openers, emphasis crutches, and all adverbs. See [Phrases to Remove](#phrases-to-remove).

2. **Break formulaic structures.** Avoid binary contrasts, negative listings, dramatic fragmentation, rhetorical setups, false agency. See [Structures to Avoid](#structures-to-avoid).
...
See [Before/After Examples](#beforeafter-examples) for transformations.
...
| All adverbs (-ly words, "really," "just," "literally," "genuinely," "honestly," "simply," "actually") | Empty emphasis. See [Adverbs](#adverbs) above for full list. |
